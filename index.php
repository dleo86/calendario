...
<head>
  ...
  <title>Administrador de clases</title>
...
<body>
 <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  ...
  <span class="openbtn">
      ...
      <h3>
        Bienvenido
        <small>  <strong><?php echo $_SESSION['usuario'];?></strong></small>
      </h3>
    </section>
  </span>  
    ...
    <div class="row">
      ...
      <div class="col-2">
          <div style="text-align:center">
            <button type="button" id="BotonEventosPredefinidos" class="btn btn-primary">Administrar clases predefinidas</button>
        </div>
        <div id='external-events' style="margin-bottom:1em; height: 550px; border: 1px solid #000; overflow: auto;padding:1em">
          <h4 class="text-center">Clases predefinidas</h4>
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6" id="TituloHoraFin">
              ...
              <div class="input-group clockpicker" data-autoclose="true" >
                <input type="text" id="HoraFin" value="" class="form-control" autocomplete="off" readonly />
              </div>
            </div>
          </div>
