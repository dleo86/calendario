...
switch ($_GET['accion']) {
    ...
    case 'consultar':
        $datos = mysqli_query($conexion, "select codigo, titulo,horainicio,horafin,colortexto,colorfondo from eventospredefinidos where codigo=$_GET[codigo]");
        $resultado = mysqli_fetch_all($datos, MYSQLI_ASSOC);
        echo json_encode($resultado);
        break;
    
    case 'modificar':
        $respuesta = mysqli_query($conexion, "update eventospredefinidos set titulo = '$_POST[titulo]',horainicio = '$_POST[horainicio]',horafin = '$_POST[horafin]',colortexto = '$_POST[colortexto]',colorfondo = '$_POST[colorfondo]' "        
